...
// use global fetch (Node 18+ / 26 has fetch)
...
async function main() {
	...
	// write raw cache files under data/national/*
	...
	// write merged detail to data/national/finra-firm-10111.json
	...
	console.log('Wrote merged file to data/national/finra-firm-10111.json');
}
